...
\begin{document}
\begin{center}
  \includegraphics[height=\dimexpr\paperheight-20pt\relax,width=\dimexpr\paperwidth-20pt\relax,keepaspectratio=true]{/home/behraz/vscode_workspace/latex/DB/database project/faze1/database.png}
\end{center}
\newpage
\noindent
